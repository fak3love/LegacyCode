...
namespace MonoScript.Analytics
{
    public static class MLog
    {
        ...
        public static void SetErrorOptions(AppMessageOptions appMessageOptions)
        {
            if (appMessageOptions == null)
                return;

            AppErrors.AppMessageOptions = appMessageOptions;
        }
        public static void SetWarningOptions(AppMessageOptions appMessageOptions)
        {
            if (appMessageOptions == null)
                return;

            AppWarnings.AppMessageOptions = appMessageOptions;
        }
    }
}
